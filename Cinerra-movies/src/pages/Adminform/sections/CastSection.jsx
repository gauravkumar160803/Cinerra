        ...
        <div>
            <div className="mb-6 flex items-start justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                        Add the actors and the characters they play
                    </p>
                </div>
                <button
                    type="button"
            ...
            {fields.length === 0 && (
                <div className="text-center py-16 text-gray-300">
                    ...
                    <p className="text-sm font-medium">No cast members added yet</p>
            ...
            <div className="space-y-4">
                {fields.map((field, index) => {
                    const memberErrors = errors.cast?.[index];
                    const imgUrl = castValues[index]?.imageUrl;
                  ...
                  hover:border-red-200 transition-all duration-150 text-xs shadow-sm"
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <FormField
                                    ...
                                    required
                                    hint="The character's name or role description"
                                >
                                    <input
                                        type="text"
                                        placeholder="e.g. Dom Cobb"
                                ...
                                <div className="sm:col-span-2">
                                    <ImageUploader
                                        fieldName={`cast.${index}.imageUrl`}
                                        label="Actor Photo"
                                        hint="Upload a headshot or press photo — max 10 MB (optional)"
